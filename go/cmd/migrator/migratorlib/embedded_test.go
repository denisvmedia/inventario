...
func TestEmbeddedFields_GenerateCreateTableWithEmbedded(t *testing.T) {
	...
	result := migratorlib.GenerateCreateTableWithEmbedded(table, fields, nil, nil, embeddedFields, "postgres")
...
func TestEmbeddedFields_PlatformSpecificOverrides(t *testing.T) {
	...
	mysqlResult := migratorlib.GenerateCreateTableWithEmbedded(table, nil, nil, nil, embeddedFields, "mysql")
	...
	mariadbResult := migratorlib.GenerateCreateTableWithEmbedded(table, nil, nil, nil, embeddedFields, "mariadb")
	...
	postgresResult := migratorlib.GenerateCreateTableWithEmbedded(table, nil, nil, nil, embeddedFields, "postgres")
