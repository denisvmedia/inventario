            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apiserver.BackofficeLoginResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.ChangePasswordRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.LoginRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apiserver.LogoutResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.BackofficeLoginRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.BackofficeLoginMFARequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apiserver.BackofficeLogoutResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apiserver.BackofficeProfile"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.FeedbackRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/apiserver.FeedbackResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.RegisterRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.ResendVerificationRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.ResetPasswordRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "apiserver.ImpersonationStateResponse": {
            ...
            "properties": {
                ...
                "operator": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/apiserver.ImpersonationOperatorView"
                        }
                    ]
                },
                "started_at": {
        ...
        "jsonapi.AdminGroupMember": {
            ...
            "properties": {
                ...
                "user": {
                    "$ref": "#/definitions/jsonapi.AdminGroupMemberUser"
                }
            }
        },
        ...
        "jsonapi.AdminGroupMembersResponse": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/jsonapi.AdminGroupMember"
                    }
                }
            }
        },
        ...
        "jsonapi.AdminTenantResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/jsonapi.AdminTenantListItem"
                }
            }
        },
        ...
        "jsonapi.AdminUserDetail": {
            ...
            "properties": {
                ...
                "group_memberships": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/jsonapi.AdminUserGroupMembership"
                    }
                },
                "id": {
                    "type": "string"
        ...
        "jsonapi.AdminUserResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/jsonapi.AdminUserDetail"
                }
            }
        },
        "jsonapi.AdminUsersResponse": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/jsonapi.AdminUserListItem"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/jsonapi.AdminListMeta"
        ...
        "jsonapi.BulkIDsRequest": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/jsonapi.BulkIDsRequestData"
                }
            }
        },
        "jsonapi.BulkIDsRequestData": {
            ...
            "properties": {
                "attributes": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/jsonapi.BulkIDsAttributes"
                        }
                    ]
                },
                "type": {
        ...
        "jsonapi.BulkMoveRequest": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/jsonapi.BulkMoveRequestData"
                }
            }
        },
        "jsonapi.BulkMoveRequestData": {
            ...
            "properties": {
                "attributes": {
                    "$ref": "#/definitions/jsonapi.BulkMoveAttributes"
                },
                "type": {
                    "type": "string"
                }
        ...
        "jsonapi.BulkResultAttrs": {
            ...
            "properties": {
                "failed": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/jsonapi.BulkResultFail"
                    }
                },
                "succeeded": {
                    "type": "array",
        ...
        "jsonapi.BulkResultData": {
            ...
            "properties": {
                "attributes": {
                    "$ref": "#/definitions/jsonapi.BulkResultAttrs"
                },
                "id": {
                    "type": "string"
                },
        ...
        "jsonapi.BulkResultResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/jsonapi.BulkResultData"
                }
            }
        },
        ...
        "jsonapi.CommodityLoanResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/jsonapi.CommodityLoanResponseData"
                }
            }
        },
        ...
        "jsonapi.CommodityScanAttributes": {
            ...
            "properties": {
                ...
                "warnings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/jsonapi.CommodityScanWarning"
                    }
                }
            }
        },
        ...
        "jsonapi.CommodityScanResource": {
            ...
            "properties": {
                "attributes": {
                    "$ref": "#/definitions/jsonapi.CommodityScanAttributes"
                },
                "type": {
                    "type": "string",
                    "enum": [
        ...
        "jsonapi.CommodityScanResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/jsonapi.CommodityScanResource"
                }
            }
        },
        ...
        "jsonapi.TagMeta": {
            ...
            "properties": {
                "usage": {
                    "$ref": "#/definitions/registry.TagUsage"
                }
            }
        },
        "jsonapi.TagRequest": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/jsonapi.TagRequestDataWrapper"
                }
            }
        },
        ...
        "jsonapi.TagRequestDataWrapper": {
            ...
            "properties": {
                "attributes": {
                    "$ref": "#/definitions/jsonapi.TagRequestData"
                },
                "id": {
                    "type": "string"
                },
        ...
        "jsonapi.TagUpdateRequest": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/jsonapi.TagUpdateRequestDataWrapper"
                }
            }
        },
        ...
        "jsonapi.TagUpdateRequestDataWrapper": {
            ...
            "properties": {
                "attributes": {
                    "$ref": "#/definitions/jsonapi.TagUpdateRequestData"
                },
                "id": {
                    "type": "string"
                },
        ...
        "jsonapi.UploadResponse": {
            ...
            "properties": {
                "attributes": {
                    "$ref": "#/definitions/jsonapi.UploadData"
                },
                "id": {
                    "type": "string"
                },
        ...
        "models.SettingsObject": {
            ...
            "properties": {
                ...
                "notificationsPriceDrop": {
                    "type": "boolean"
                },
                "notificationsWarrantyExpiry": {
        ...
        "services.StorageUsage": {
            ...
            "properties": {
                "breakdown": {
                    "$ref": "#/definitions/registry.StorageBreakdown"
                },
                "quota_bytes": {
                    "type": "integer"
                },
