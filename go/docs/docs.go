...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apiserver.AdminUserListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.AdminUserCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiserver.AdminUserUpdateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "apiserver.AdminUserCreateRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "apiserver.AdminUserListResponse": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer"
        ...
        "apiserver.AdminUserUpdateRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
