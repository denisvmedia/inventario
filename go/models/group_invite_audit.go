...
//
//ptah:schema:rls:enable table="group_invites_audit" comment="Enable RLS for multi-tenant group invite audit isolation"
...
//ptah:schema:rls:policy name="group_invite_audit_background_worker_access" table="group_invites_audit" for="ALL" to="inventario_background_worker" using="true" with_check="true" comment="Allows background workers to insert audit rows during group purge"

//ptah:schema:table name="group_invites_audit"
type GroupInviteAudit struct {
	...
	//ptah:schema:field name="original_invite_id" type="TEXT" not_null="true"
	...
	//ptah:schema:field name="original_invite_uuid" type="TEXT" not_null="true"
	...
	//ptah:schema:field name="original_group_id" type="TEXT" not_null="true"
	...
	//ptah:schema:field name="original_group_slug" type="TEXT" not_null="true"
	...
	//ptah:schema:field name="original_group_name" type="TEXT" not_null="true"
	...
	//ptah:schema:field name="created_by" type="TEXT" not_null="true" foreign="users(id)" foreign_key_name="fk_invite_audit_created_by"
	...
	// by the expiry sweep).
	//ptah:schema:field name="used_by" type="TEXT" not_null="true" foreign="users(id)" foreign_key_name="fk_invite_audit_used_by"
	UsedBy string `json:"used_by" db:"used_by" userinput:"false"`

	// OriginalCreatedAt is when the invite was originally generated.
	//ptah:schema:field name="original_created_at" type="TIMESTAMP" not_null="true"
	...
	//ptah:schema:field name="original_expires_at" type="TIMESTAMP" not_null="true"
	...
	//ptah:schema:field name="used_at" type="TIMESTAMP" not_null="true"
	...
	//ptah:schema:field name="archived_at" type="TIMESTAMP" not_null="true" default_expr="CURRENT_TIMESTAMP"
...
type GroupInviteAuditIndexes struct {
	//ptah:schema:index name="idx_group_invites_audit_uuid" fields="uuid" unique="true" table="group_invites_audit"
	_ int
	...
	//ptah:schema:index name="idx_group_invites_audit_tenant_invite" fields="tenant_id,original_invite_id" unique="true" table="group_invites_audit"
	_ int

	//ptah:schema:index name="idx_group_invites_audit_tenant_id" fields="tenant_id" table="group_invites_audit"
	_ int

	//ptah:schema:index name="idx_group_invites_audit_original_group_id" fields="original_group_id" table="group_invites_audit"
	_ int

	//ptah:schema:index name="idx_group_invites_audit_used_by" fields="used_by" table="group_invites_audit"
	_ int

	//ptah:schema:index name="idx_group_invites_audit_archived_at" fields="archived_at" table="group_invites_audit"
	_ int
}
