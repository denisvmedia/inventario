...
//
//ptah:schema:rls:enable table="storage_quota_reminders" comment="Enable RLS for multi-tenant storage quota reminder isolation"
...
//ptah:schema:rls:policy name="storage_quota_reminder_background_worker_access" table="storage_quota_reminders" for="ALL" to="inventario_background_worker" using="true" with_check="true" comment="Allows background workers to record reminder emissions across all groups"
...
//
//ptah:schema:table name="storage_quota_reminders"
type StorageQuotaReminder struct {
	...
	//ptah:schema:field name="threshold_percent" type="INTEGER" not_null="true"
...
type StorageQuotaReminderIndexes struct {
	...
	//ptah:schema:index name="idx_storage_quota_reminders_group_threshold" fields="group_id,threshold_percent" unique="true" table="storage_quota_reminders"
	_ int

	// Tenant-scoped index for housekeeping queries.
	//ptah:schema:index name="idx_storage_quota_reminders_tenant_id" fields="tenant_id" table="storage_quota_reminders"
	_ int
}
