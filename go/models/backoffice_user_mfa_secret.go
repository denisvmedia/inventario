...
//ptah:schema:table name="backoffice_user_mfa_secrets"
type BackofficeUserMFASecret struct {
	...
	//ptah:schema:field name="backoffice_user_id" type="TEXT" not_null="true" foreign="backoffice_users(id)" foreign_key_name="fk_backoffice_mfa_user"
	...
	//ptah:schema:field name="backup_codes_hashed" type="JSONB" not_null="true" default_expr="'[]'"
...
type BackofficeUserMFASecretIndexes struct {
	...
	//ptah:schema:index name="idx_backoffice_user_mfa_secrets_uuid" fields="uuid" unique="true" table="backoffice_user_mfa_secrets"
	_ int

	// One MFA row per back-office user.
	//ptah:schema:index name="idx_backoffice_user_mfa_secrets_user" fields="backoffice_user_id" unique="true" table="backoffice_user_mfa_secrets"
	_ int
}
