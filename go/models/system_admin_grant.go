...
//
//ptah:schema:table name="system_admin_grants"
type SystemAdminGrant struct {
	...
	//ptah:schema:field name="user_id" type="TEXT" not_null="true" foreign="users(id)" foreign_key_name="fk_system_admin_grants_user" on_delete="CASCADE"
	...
	//ptah:schema:field name="granted_by" type="TEXT" foreign="users(id)" foreign_key_name="fk_system_admin_grants_granted_by" on_delete="SET NULL"
	...
	//ptah:schema:field name="granted_at" type="TIMESTAMP" not_null="true" default_expr="CURRENT_TIMESTAMP"
...
type SystemAdminGrantIndexes struct {
	...
	//ptah:schema:index name="idx_system_admin_grants_uuid" fields="uuid" unique="true" table="system_admin_grants"
	_ int
	...
	//ptah:schema:index name="system_admin_grants_user_id_idx" fields="user_id" unique="true" table="system_admin_grants"
	_ int
}
