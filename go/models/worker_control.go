...
const (
	...
	// WorkerTypeOperationSlotCleanup pauses the operation-slot cleanup worker.
	WorkerTypeOperationSlotCleanup WorkerType = "operation-slot-cleanup"
...
var allWorkerTypes = []WorkerType{
	...
	WorkerTypeOperationSlotCleanup,
