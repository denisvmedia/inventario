...
//ptah:schema:rls:policy name="location_background_worker_access" table="locations" for="ALL" to="inventario_background_worker" using="true" with_check="true" comment="Allows background workers to access all locations for processing"
...
type Location struct {
	...
	//ptah:schema:field name="address" type="TEXT" not_null="true"
...
type LocationIndexes struct {
	...
	//ptah:schema:index name="idx_locations_uuid" fields="uuid" unique="true" table="locations"
	_ int

	// Index for tenant-based queries
	//ptah:schema:index name="idx_locations_tenant_id" fields="tenant_id" table="locations"
	_ int

	// Composite index for tenant+group RLS-filtered queries (e.g. list-by-group)
	//ptah:schema:index name="idx_locations_tenant_group" fields="tenant_id,group_id" table="locations"
	_ int
}
