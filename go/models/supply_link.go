...
//
//ptah:schema:rls:enable table="commodity_supply_links" comment="Enable RLS for multi-tenant supply-link isolation"
...
//ptah:schema:rls:policy name="supply_link_background_worker_access" table="commodity_supply_links" for="ALL" to="inventario_background_worker" using="true" with_check="true" comment="Allows background workers to access all supply links for processing"
//ptah:schema:table name="commodity_supply_links"
type SupplyLink struct {
	...
	//ptah:schema:field name="commodity_id" type="TEXT" not_null="true" foreign="commodities(id)" foreign_key_name="fk_supply_link_commodity" on_delete="CASCADE"
	...
	//ptah:schema:field name="url" type="TEXT" not_null="true"
	...
	//ptah:schema:field name="sort_order" type="INTEGER" not_null="true" default="0"
...
// SupplyLinkIndexes carries the ptah:schema:index tags. The empty
...
type SupplyLinkIndexes struct {
	...
	// import/restore).
	//ptah:schema:index name="idx_supply_links_uuid" fields="uuid" unique="true" table="commodity_supply_links"
	_ int

	// Index for tenant-based queries.
	//ptah:schema:index name="idx_supply_links_tenant_id" fields="tenant_id" table="commodity_supply_links"
	_ int

	// Composite index for tenant+group RLS-filtered queries.
	//ptah:schema:index name="idx_supply_links_tenant_group" fields="tenant_id,group_id" table="commodity_supply_links"
	_ int
	...
	//ptah:schema:index name="idx_supply_links_commodity" fields="commodity_id,sort_order" table="commodity_supply_links"
	_ int
}
