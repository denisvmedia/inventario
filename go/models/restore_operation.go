...
var (
	...
	_ TenantGroupAwareIDable            = (*RestoreOperation)(nil)
...
//migrator:schema:rls:policy name="restore_operation_isolation" table="restore_operations" for="ALL" to="inventario_app" using="tenant_id = get_current_tenant_id() AND get_current_tenant_id() IS NOT NULL AND get_current_tenant_id() != '' AND ((get_current_group_id() IS NOT NULL AND get_current_group_id() != '' AND group_id = get_current_group_id()) OR (get_current_user_id() IS NOT NULL AND get_current_user_id() != '' AND created_by_user_id = get_current_user_id()))" with_check="tenant_id = get_current_tenant_id() AND get_current_tenant_id() IS NOT NULL AND get_current_tenant_id() != '' AND ((get_current_group_id() IS NOT NULL AND get_current_group_id() != '' AND group_id = get_current_group_id()) OR (get_current_user_id() IS NOT NULL AND get_current_user_id() != '' AND created_by_user_id = get_current_user_id()))" comment="Ensures restore operations can only be accessed and modified by their tenant and group with required contexts"
