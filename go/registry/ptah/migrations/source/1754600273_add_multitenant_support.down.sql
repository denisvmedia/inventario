-- Migration rollback
-- Generated on: 2025-08-07T22:57:53+02:00
-- Direction: DOWN
...
-- ALTER statements: --
ALTER TABLE manuals DROP COLUMN tenant_id;
-- WARNING: Dropping column manuals.tenant_id - This will delete data! --
...
-- WARNING: Dropping column exports.tenant_id - This will delete data! --
...
-- WARNING: Dropping column invoices.tenant_id - This will delete data! --
-- Modify table: images --
-- ALTER statements: --
ALTER TABLE images ADD COLUMN id text PRIMARY KEY NOT NULL;
-- ALTER statements: --
ALTER TABLE images DROP COLUMN tenant_id;
-- WARNING: Dropping column images.tenant_id - This will delete data! --
-- Modify table: restore_steps --
-- ALTER statements: --
ALTER TABLE restore_steps ADD COLUMN id text PRIMARY KEY NOT NULL;
-- ALTER statements: --
ALTER TABLE restore_steps DROP COLUMN tenant_id;
-- WARNING: Dropping column restore_steps.tenant_id - This will delete data! --
...
-- WARNING: Dropping column locations.tenant_id - This will delete data! --
-- Modify table: files --
-- ALTER statements: --
ALTER TABLE files ADD COLUMN id text PRIMARY KEY NOT NULL;
-- ALTER statements: --
ALTER TABLE files DROP COLUMN tenant_id;
-- WARNING: Dropping column files.tenant_id - This will delete data! --
-- Modify table: areas --
-- ALTER statements: --
ALTER TABLE areas ADD COLUMN id text PRIMARY KEY NOT NULL;
-- ALTER statements: --
ALTER TABLE areas DROP COLUMN tenant_id;
-- WARNING: Dropping column areas.tenant_id - This will delete data! --
-- Modify table: commodities --
-- ALTER statements: --
ALTER TABLE commodities ADD COLUMN id text PRIMARY KEY NOT NULL;
-- ALTER statements: --
ALTER TABLE commodities DROP COLUMN tenant_id;
-- WARNING: Dropping column commodities.tenant_id - This will delete data! --
...
-- ALTER statements: --
ALTER TABLE restore_operations DROP COLUMN tenant_id;
-- WARNING: Dropping column restore_operations.tenant_id - This will delete data! --
