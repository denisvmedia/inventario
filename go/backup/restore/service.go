...
func (l *RestoreOperationProcessor) processFile(ctx context.Context, t xml.StartElement, decoder *xml.Decoder, xmlFile *XMLFile, stats *RestoreStats) error {
	switch t.Name.Local {
	case "path":
...
func (l *RestoreOperationProcessor) createImageRecord(ctx context.Context, file *models.File, commodityID, originalXMLID string, stats *RestoreStats, existing *ExistingEntities, idMapping *IDMapping, options RestoreOptions) error {
...
//nolint:dupl,gocognit // Similar but not the same as other create*Record functions (and is readable enough)
func (l *RestoreOperationProcessor) createInvoiceRecord(ctx context.Context, file *models.File, commodityID, originalXMLID string, stats *RestoreStats, existing *ExistingEntities, idMapping *IDMapping, options RestoreOptions) error {
...
func (l *RestoreOperationProcessor) restoreTopLevelElements(ctx context.Context, t xml.StartElement, decoder *xml.Decoder, stats *RestoreStats, existingEntities *ExistingEntities, idMapping *IDMapping, options RestoreOptions) error {
	switch t.Name.Local {
	case "inventory":
...
func (l *RestoreOperationProcessor) processLocation(ctx context.Context, decoder *xml.Decoder, startElement *xml.StartElement, stats *RestoreStats, existing *ExistingEntities, idMapping *IDMapping, options RestoreOptions) error {
...
func (l *RestoreOperationProcessor) processArea(ctx context.Context, decoder *xml.Decoder, startElement *xml.StartElement, stats *RestoreStats, existing *ExistingEntities, idMapping *IDMapping, options RestoreOptions) error {
	var xmlArea XMLArea
...
func (l *RestoreOperationProcessor) processCommodity(ctx context.Context, decoder *xml.Decoder, startElement *xml.StartElement, stats *RestoreStats, existing *ExistingEntities, idMapping *IDMapping, options RestoreOptions) error {
...
func (l *RestoreOperationProcessor) createOrUpdateCommodity(ctx context.Context, xmlCommodity *XMLCommodity, stats *RestoreStats, existing *ExistingEntities, idMapping *IDMapping, options RestoreOptions) error {
	// Store the original XML IDs for mapping
...
func (l *RestoreOperationProcessor) getActionDescription(action string, options RestoreOptions) string {
	prefix := ""
	if options.DryRun {
