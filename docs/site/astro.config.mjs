      ...
      sidebar: [
        {
          ...
          translations: { cs: 'Začínáme', ru: 'Начало работы' },
          slug: 'getting-started',
        },
        {
          label: 'Using Inventario',
          translations: { cs: 'Práce s Inventariem', ru: 'Работа с Inventario' },
          items: [
            { slug: 'items' },
        ...
        {
          label: 'Data & sharing',
          translations: { cs: 'Data a sdílení', ru: 'Данные и доступ' },
          items: [{ slug: 'backup-and-restore' }, { slug: 'groups-and-sharing' }],
        },
        {
          label: 'Account',
          translations: { cs: 'Účet', ru: 'Аккаунт' },
          items: [{ slug: 'settings-and-account' }],
        },
        {
          label: 'Install',
          translations: { cs: 'Instalace', ru: 'Установка' },
          items: [{ slug: 'self-hosting' }],
        },
        {
          label: 'Help',
          translations: { cs: 'Nápověda', ru: 'Помощь' },
          items: [{ slug: 'troubleshooting' }],
        },
        {
          label: 'Reference',
          translations: { cs: 'Referenční příručka', ru: 'Справочник' },
          items: [{ slug: 'api' }],
        },
      ],
    }),
