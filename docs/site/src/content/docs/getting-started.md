...
description: A quick tour of Inventario and how to add your first item, by hand or with AI.
---
...
![The Inventario dashboard with the Add item button](../../assets/screenshots/dashboard.png)
...
![The Add item dialog, showing the Fill with AI and Fill manually options](../../assets/screenshots/add-item-dialog.png)
