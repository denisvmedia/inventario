...
| `demo.minio.enabled` | `false` | Turn on an in-cluster demo object store and S3-style uploads. SeaweedFS since MinIO withdrew anonymous image pulls; the values keys keep the `minio` name because they name the role. |
