...
The `frontend/` perf gates from #1420. Two gates run on every PR; both can fail the merge.

## Bundle size — `size-limit`

Config: `frontend/.size-limit.json`. Three groups:
...
Config: `frontend/lighthouserc.cjs`. Thresholds (per #1420 AC):
