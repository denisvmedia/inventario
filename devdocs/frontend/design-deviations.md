...
- **Approved by**: agent-suggested — scoped to issue #1962's four enumerated defects (the issue frames the layout reconciliation as the padding/full-bleed fix, not a recomposition).
