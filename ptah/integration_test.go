		...
		t.Run(filepath.Base(file), func(t *testing.T) {
			...
			for _, table := range tables {
				t.Run(table.Name, func(t *testing.T) {
					...
					pgSQL := generators.GenerateCreateTable(table, fields, indexes, enums, "postgres")
					...
					// Generate MySQL SQL
					mySQL := generators.GenerateCreateTable(table, fields, indexes, enums, "mysql")
					...
					mariaSQL := generators.GenerateCreateTable(table, fields, indexes, enums, "mariadb")
