...
func CompareSchemas(generated *builder.PackageParseResult, database *DatabaseSchema) *SchemaDiff {
	diff := &SchemaDiff{}
...
func compareTablesAndColumns(generated *builder.PackageParseResult, database *DatabaseSchema, diff *SchemaDiff) {
...
func compareTableColumns(genTable meta.TableDirective, dbTable Table, generated *builder.PackageParseResult) TableDiff {
	tableDiff := TableDiff{TableName: genTable.Name}

	// Process embedded fields to get the complete field list (same as generators do)
	embeddedGeneratedFields := meta.ProcessEmbeddedFields(generated.EmbeddedFields, generated.Fields, genTable.StructName)
...
func compareEnums(generated *builder.PackageParseResult, database *DatabaseSchema, diff *SchemaDiff) {
	// Create maps for quick lookup
...
func compareIndexes(generated *builder.PackageParseResult, database *DatabaseSchema, diff *SchemaDiff) {
	// Create sets for comparison
...
func (d *SchemaDiff) GenerateMigrationSQL(generated *builder.PackageParseResult, dialect string) []string {
