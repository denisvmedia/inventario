...
func TestIndexBuilder_MultipleColumns(t *testing.T) {
	...
	index := astbuilder.NewIndex("idx_posts_user_created", "posts", "user_id", "created_at")
...
func TestIndexBuilder_FluentChaining(t *testing.T) {
	...
	index := astbuilder.NewIndex("test_index", "test_table", "col1")
...
func TestIndexBuilder_NoColumns(t *testing.T) {
	...
	index := astbuilder.NewIndex("idx_empty", "test_table")
...
func TestIndexBuilder_HashIndex(t *testing.T) {
	...
	index := astbuilder.NewIndex("idx_users_id_hash", "users", "id").
		Type("HASH").
...
func TestIndexBuilder_GinIndex(t *testing.T) {
	...
	index := astbuilder.NewIndex("idx_posts_tags", "posts", "tags").
		Type("GIN").
...
func TestIndexBuilder_PartialIndex(t *testing.T) {
	...
	index := astbuilder.NewIndex("idx_users_active_email", "users", "email").
		Unique().
...
func TestIndexBuilder_CompositeUniqueIndex(t *testing.T) {
	...
	index := astbuilder.NewIndex("idx_user_roles_unique", "user_roles", "user_id", "role_id").
		Unique().
...
func TestIndexBuilder_PerformanceIndex(t *testing.T) {
	...
	index := astbuilder.NewIndex("idx_orders_customer_date", "orders", "customer_id", "order_date").
		Type("BTREE").
