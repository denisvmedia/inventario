...
func ExampleGenerateCreateTable() {
	...
	pgSQL := generators.GenerateCreateTable(productTable, fields, indexes, enums, "postgres")
	...
	// Generate for MySQL
	mySQL := generators.GenerateCreateTable(productTable, fields, indexes, enums, "mysql")
...
func Example_platformSpecificAttributes() {
	...
	mySQL := generators.GenerateCreateTable(productTable, fields, nil, nil, "mysql")
	...
	pgSQL := generators.GenerateCreateTable(productTable, fields, nil, nil, "postgres")
