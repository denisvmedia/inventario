...
//migrator:schema:index table="products" name="idx_products_category_id" columns="category_id"
...
//migrator:schema:foreign_key table="products" name="fk_products_category_id" columns="category_id" ref_table="categories" ref_columns="id" on_delete="SET NULL"
