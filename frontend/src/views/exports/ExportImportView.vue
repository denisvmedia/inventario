<template>
  <div class="export-detail-page">
    ...
    <div class="header">
      <h1>Import Export</h1>
      <p class="subtitle">Upload an XML export file to create a new export record</p>
    </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            />
            <div class="form-help">
              Select an XML export file that was previously generated by this application
            </div>
    ...
    <!-- Form Errors -->
    <div v-if="formError && Object.keys(formError).length > 0" class="form-errors">
...
const scrollToFirstError = () => {
  setTimeout(() => {
    const firstError = document.querySelector('.field-error, .form-errors')
    if (firstError) {
