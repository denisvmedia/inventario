...
describe('CommodityListItem.vue', () => {
  ...
  describe('Helper Functions', () => {
    it('returns correct type icon based on commodity type', () => {
      ...
      const vm = wrapper.vm as { getTypeIcon: (string) => string }
    ...
    it('returns correct type name based on commodity type', () => {
      ...
      // Access the component instance
      const vm = wrapper.vm as { getTypeName: (string) => string }
    ...
    it('returns correct status name based on commodity status', () => {
      ...
      // Access the component instance
      const vm = wrapper.vm as { getStatusName: (string) => string }
    ...
    it('returns correct area name based on area ID', () => {
      ...
      // Access the component instance
      const vm = wrapper.vm as { getAreaName: (string) => string }
    ...
    it('returns correct location name based on area ID', () => {
      ...
      // Access the component instance
      const vm = wrapper.vm as { getLocationName: (string) => string }
  ...
  describe('Edge Cases', () => {
    ...
    it('handles missing area in areaMap', () => {
      ...
      // Access the component instance
      const vm = wrapper.vm as { getAreaName: (string) => string, getLocationName: (string) => string }
  ...
  describe('Purchase Date Display', () => {
    ...
    it('formats purchase date correctly', () => {
      const wrapper = createWrapper()
      const vm = wrapper.vm as { formatPurchaseDate: (string) => string }
