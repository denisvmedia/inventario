...
// There is deliberately no admin entry here. #1785 moved /admin/* behind
// the back-office auth plane, which is a separate identity with its own
// login at /backoffice/login — a tenant session cannot reach it whatever
// grants it holds. A link from this sidebar would bounce the user to a
// login screen for a plane they may have no account on (#2475).
